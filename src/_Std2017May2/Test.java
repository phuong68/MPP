...
public class Test {
	...
	public static void main(String[] args) {
		...
		records[0].addCheckoutRecordEntry(entries[0]);
		records[0].addCheckoutRecordEntry(entries[1]);
		records[0].addCheckoutRecordEntry(entries[10]);
		records[0].addCheckoutRecordEntry(entries[11]);
		
		records[1].addCheckoutRecordEntry(entries[2]);
		records[1].addCheckoutRecordEntry(entries[3]);
		records[1].addCheckoutRecordEntry(entries[12]);
		records[1].addCheckoutRecordEntry(entries[13]);
		
		records[2].addCheckoutRecordEntry(entries[4]);
		records[2].addCheckoutRecordEntry(entries[14]);
		records[2].addCheckoutRecordEntry(entries[15]);
		
		records[3].addCheckoutRecordEntry(entries[16]);
		records[3].addCheckoutRecordEntry(entries[17]);
		
		records[4].addCheckoutRecordEntry(entries[5]);
		records[4].addCheckoutRecordEntry(entries[6]);
		records[4].addCheckoutRecordEntry(entries[18]);
		
		records[5].addCheckoutRecordEntry(entries[19]);
		records[5].addCheckoutRecordEntry(entries[20]);
		
		records[6].addCheckoutRecordEntry(entries[7]);
		records[6].addCheckoutRecordEntry(entries[8]);
		records[6].addCheckoutRecordEntry(entries[21]);
		records[6].addCheckoutRecordEntry(entries[22]);
		
		records[7].addCheckoutRecordEntry(entries[9]);
		records[7].addCheckoutRecordEntry(entries[23]);
		records[7].addCheckoutRecordEntry(entries[24]);
		
		records[8].addCheckoutRecordEntry(entries[10]);
		records[8].addCheckoutRecordEntry(entries[25]);
	...
	private static void setNumCopies(CD[] cds, Book[] books) {
		int count = 0;
		for(CD c: cds) {
			c.setNumOfCopiesInLib(1 + (count++) % 3);
		}
		for(Book b: books) {
			b.setNumOfCopiesInLib(1 + (count++) % 3);
		}
	}
